...
desc 'Generate documentation for the opengraph extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'OpengraphExtension'
...
desc 'Test the opengraph extension.'
...
namespace :test do
  desc 'Functional test the opengraph extension.'
  ...
  desc 'Unit test the opengraph extension.'
